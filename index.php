...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="icofont-envelope"></i><a href="mailto:contact@example.com">abdelmounaim@gmail.com</a>
        <i class="icofont-phone"></i> +337690925**
      </div>
  ...
  <header id="header">
    <div class="container">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="index.php"><span>DAZE||AE</span></a></h1>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="bts.html">BTS SIO</a></li>
          ...
          <div class="carousel-item active" style="background-image: url('assets/img/photo-Accueil.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <p class="animated fadeInUp"> Étudiant et  Développeur Web</p>
  ...
  <main id="main">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              ...
              <p>Je m’appelle EL HOUZI Abdelmounaim, je suis âgé de 21 ans. Je suis actuellement étudiant à Nîmes au lycée Cci Gard, en deuxième année de BTS 
                « SIO spécialité Slam » Services Informatiques aux Organisations spécialité en Solutions logicielle et applications. Depuis mes jeunes 
                années, j’ai toujours été attiré par l’informatique et les nouvelles technologies.</p>
            </div>
    ...
    <section id="resume" class="resume">
      ...
      <div class="container">
       ...
       <a class="buta" href="assets/fichier/cv.pdf" > Consulter cv</a>
          
          <a class="butb" href="assets/fichier/cv.pdf">Télécharger cv</a>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>
              X Rue watt <br>
             30000, Nîmes<br><br>
              <strong>Téléphone:</strong> +337690925**<br>
              <strong>E-mail:</strong> abdelmounaim@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>DAZE||AE</span></strong>
      </div>
      <div class="credits">
